...
if &t_Co > 255
   ...
   hi MatchParen      ctermfg=081 ctermbg=233   cterm=bold
   hi ModeMsg         ctermfg=229
   hi MoreMsg         ctermfg=229
   hi Operator        ctermfg=118

   " complete menu
   hi Pmenu           ctermfg=135 ctermbg=234
   hi PmenuSel        ctermfg=bg  ctermbg=135  cterm=bold
   hi PmenuSbar       ctermfg=118 ctermbg=161
   hi PmenuThumb      ctermfg=118 ctermbg=161
   ...
   hi StatusLineNC    ctermfg=244 ctermbg=bg
   ...
   hi VertSplit       ctermfg=244 ctermbg=bg    cterm=bold
